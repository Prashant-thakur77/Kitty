export const cfg = {
  ...
  credit: (import.meta.env.VITE_KITTY_CREDIT_ADDRESS ?? '') as `0x${string}`,
  badge: (import.meta.env.VITE_KITTY_BADGE_ADDRESS ?? '') as `0x${string}`,
  kusd: (import.meta.env.VITE_KITTY_USD_ADDRESS ?? '') as `0x${string}`,
