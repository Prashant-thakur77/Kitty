...
const NODES = [
  ...
  { k: 'clock', t: 'Clock', chain: '0x0FD3', d: 'On time iff proven height ≤ deadline height. closeRound is allowed early when full, else only when is_height_attested(deadline).', file: 'src/interfaces/IChainInfo.sol', tone: 'amber' },
    ...
    <main className="mx-auto max-w-6xl px-4 py-8">
      ...
      <section className="panel mt-6 p-5">
        ...
        <div className="mt-4 grid gap-2 md:grid-cols-3 text-sm">
          {[['Block prover', '0x0000…0FD2', 'verifyAndEmit (single + batch), calculateTxIndex'], ['ChainInfo', '0x0000…0fD3', 'is_height_attested, get_latest_attestation_height_and_hash'], ['Proof Builder', 'prover.cc3-testnet', '/api/v1/proof-batch-by-tx, /attested-height/1']].map(([a, b, c]) => (
