...
segments = [
 ...
 ("05_live", "Here is the real thing, on Creditcoin testnet and Sepolia. Three circles are live. This one settled a whole round earlier today. Let me connect a wallet. I am member two of the Oaxaca Tanda."),
 ("06_circle", "Look at the deadline. It is not a date. It is a Sepolia block number, and the scale shows exactly which of those blocks the attestor network has already attested on Creditcoin. The rotation runs by proven score, and the round history shows what the ledger has seen."),
 ...
 ("12_telegram", "Members do not live in block explorers. They live in Telegram. The Kitty bot watches the ledger and tells you when your payment is proven, when a round closes, when your pot lands, and when a deadline is close. The dashboard opens inside Telegram as a mini app."),
